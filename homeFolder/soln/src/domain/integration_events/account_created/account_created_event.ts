...
import { IAccountCreatedIntegrationEventProps } from './account_created_event_props';
...
export class AccountCreatedIntegrationEvent extends IntegrationEvent {
    data: IAccountCreatedIntegrationEventProps;
    topicName: string;

    private constructor(props: IAccountCreatedIntegrationEventProps, eventType: string, eventSource: string, context: RequestContext, topicName: string, messageKey?: string) {
    ...
    public static create(props: IAccountCreatedIntegrationEventProps): AccountCreatedIntegrationEvent {
        ...
        return new AccountCreatedIntegrationEvent(props, EVENT_TYPE, SOURCE, CONTEXT, 'BankAccounts', props.id);
    }
}
