...
export class TransactionProcessedIntegrationEventIntegrationEvent extends IntegrationEvent {
    data: ITransactionProcessedIntegrationEventIntegrationEventProps;
    topicName: string;

    private constructor(
        props: ITransactionProcessedIntegrationEventIntegrationEventProps,
        eventType: string,
        eventSource: string,
    ...
    public static create(props: ITransactionProcessedIntegrationEventIntegrationEventProps): TransactionProcessedIntegrationEventIntegrationEvent {
        ...
        return new TransactionProcessedIntegrationEventIntegrationEvent(props, EVENT_TYPE, SOURCE, CONTEXT, 'TransactionProcessed', props.id);
    }
}
